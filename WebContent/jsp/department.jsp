<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.intellion.business.DeptBO" %>
        ...
        <div class="col-md-2 menucontent">
            ...
            <a href="#"><h1>Dashboard</h1></a>
                ...
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li role="presentation"><a href="../jsp/nurse.jsp">Nurse</a></li>
        ...
        <div class="panel-body">
            ...
            <!----------------   Display Department Data List start   --------------->
				    ...
				    DeptBO deptBO=new DeptBO();
           			List<DeptVO> deptVOList = deptBO.getDeptList();
           			
           			System.out.println("deptVOList size..:"+deptVOList.size());
					...
					<%
				 	if(null != deptVOList && deptVOList.size() > 0)
				 		...
				 		for(int i=0; i<deptVOList.size(); i++ ){
				 			...
				 			DeptVO deptVO = (DeptVO)deptVOList.get(i);
			        %>                   
                   <tr>
                           <td><%=deptVO.getDeptId()%></td>
                           <td><%=deptVO.getDeptName()%></td>
                           <td><%=deptVO.getDeptDesc()%></td>
                           <td>
						    <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"> -->
						    <button type="button" class="btn btn-primary" onclick="showData(<%=deptVO.getDeptId()%>)">
...
<!----------------   Modal ends here  --------------->
              ...
              <!----------------   Add Department Start   --------------->
				<%
				 	...
				 	int deptIdMax = deptBO.getDeptIDMax();
				 	deptIdMax++;
               ...
               <div id="adddoctor" class="switchgroup">
                   <div class="panel panel-default">
                       <div class="panel-body">
                           <form id="add_dept" class="form-horizontal" method="post" action="../AddDept?operation=ADD">

                            <div class="form-group">
                                <label  class="col-sm-4 control-label">Department ID</label>
                                <div class="col-sm-4">
                                  <input type="number" class="form-control" name="deptId"  value="<%=deptIdMax %>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-4 col-sm-10">
                                  <button type="submit" onclick="onSubmit();" class="btn btn-primary">Add Department</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
function onSubmit(){
	document.forms["add_dept"].submit();
}
